 ...
 *                       For APM32F105xx and APM32F107xx devices:
 *                        This parameter can be one of the following values:
 *                        @arg RCM_PLLMF_4  : PLL Multiplication Factor config to 4
 *                        @arg RCM_PLLMF_5  : PLL Multiplication Factor config to 5
 *                        @arg RCM_PLLMF_6  : PLL Multiplication Factor config to 6
 *                        @arg RCM_PLLMF_7  : PLL Multiplication Factor config to 7
 *                        @arg RCM_PLLMF_8  : PLL Multiplication Factor config to 8
 *                        @arg RCM_PLLMF_9  : PLL Multiplication Factor config to 9
 *                        @arg RCM_PLLMF_6_5: PLL Multiplication Factor config to 6.5
 *                       For other devices:
...
/*!
 * @brief     Configs the PLL prescaler 1 factor.
 *
...
/*!
 * @brief     Configs the PLL prescaler 2 factor.
 *
...
/*!
 * @brief     Configs the PLL2 clock multiplication factor
 *
...
/*!
 * @brief     Configs the PLL3 clock multiplication factor
 *
...
/*!
 * @brief     Configs the OTG FS clock prescaler
 *
