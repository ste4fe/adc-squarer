 ...
 *
 * @brief       CMSIS Cortex-M3 Device Peripheral Access Layer System Source
 * File
 *
 * @version     V1.0.3
 *
 ...
 * Values The SystemCoreClock variable contains the core clock (HCLK)
 *
 * @param       None
 *
 * @retval      None
        ...
        case 2:
            ...
            if (pllSource) {
                ...
                if (RCM->CFG2_B.PLLPSC1SRC) {
                    pll2Mull = (RCM->CFG2_B.PLL2MUL != 15)
                                   ? (RCM->CFG2_B.PLL2MUL + 2)
                                   : 20;
...
/*!
 * @brief       Selects HSE as System clock source and configure HCLK, PCLK2 and
 * PCLK1 prescalers
 *
 * @param       None
 *
...
#elif defined SYSTEM_CLOCK_48MHz
/*!
 * @brief       Sets System clock frequency to 46MHz and configure HCLK, PCLK2
 * and PCLK1 prescalers
 *
 * @param       None
 *
